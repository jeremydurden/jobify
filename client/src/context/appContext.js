...
const AppProvider = ({ children }) => {
  ...
  const getJobs = async () => {
    ...
    try {
      //axios setup makes the authFetch intance default to a get request but you can also use .get
  ...
  const showStats = async () => {
    ...
    try {
      //defaults to a get request and has a base uri of /api/v1
